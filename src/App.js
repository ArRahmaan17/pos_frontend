      ...
      <div className='flex flex-row gap-0'>
        ...
        <div className="flex flex-col w-full dark:bg-slate-600">
          ...
          <div className='px-2 flex flex-col sm:flex-row gap-x-5 gap-y-1 md:gap-y-0'>
            <div className='w-full sm:w-3/4 md:w-1/2 bg-slate-50 bg-opacity-90 dark:shadow-slate-50/20 dark:shadow-2xl rounded-md shadow-lg md:pt-6'>
            ...
            <div className='w-full sm:w-3/12 md:w-1/2 grid grid-flow-dense grid-cols-3 grid-rows-1 sm:grid-cols-2 sm:grid-rows-2 flex-wrap gap-x-1 gap-y-1  h-fit'>
              <AnalyticCard color={"indigo"} size={'col-span-1 sm:col-span-2'} title={"Penjualan Hari ini"} description={"*berubah saat pesanan selesai"} icon={ShoppingCartIcon} valueChange={<CountUp end={moneyIn} duration={5} prefix="Rp. " />} />
